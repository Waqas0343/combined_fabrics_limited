...
class InspectionDashBoard extends StatelessWidget {
  const InspectionDashBoard({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Goods Inspection DashBoard"),
        actions: [
          IconButton(
      ...
      body: LayoutBuilder(builder: (context, constraints) {
        ...
        return ListView(
          ...
          children: <Widget>[
              ...
              children: [
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      Get.toNamed(AppRoutes.goodsInspectionHome);
                    },
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      Get.toNamed(AppRoutes.goodsInspectionReceiveIGP);
                    },
                    child: const ComplaintPortalCard(
                      icon: Icon(Icons.receipt_long_outlined),
                      color: Color(0xFF50C9C3),
                      titleText: '',
                      subTitleText: "Receive IGP s",
                    ),
                  ),
                ),
              ],
            ...
            GestureDetector(
              onTap: () => Get.toNamed(AppRoutes.goodsInspectionNotification),
              child: const ComplaintPortalCard(
                icon: Icon(
                  Icons.notifications,
                  color: Colors.orange,
                ...
                titleText: '',
                subTitleText: "Physical Inspections",
              ),
            ),
          ],
        );
