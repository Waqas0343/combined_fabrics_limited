...
import '../controllers/rowing_quality_top_fault_without_operation_controller.dart';
import '../models/rowing_quality_Top_fault_without_operation_model.dart';
import '../widget/end_line_summary_report.dart';

class EndLineTopFiveDefectWithoutOperation extends StatelessWidget {
  const EndLineTopFiveDefectWithoutOperation({super.key});

  @override
  Widget build(BuildContext context) {
    final EndLineTopFiveDefectWithoutOperationController controller = Get.put(EndLineTopFiveDefectWithoutOperationController());
    final ScrollController scrollController = ScrollController();
    return Scaffold(
      appBar: AppBar(
        title: const Text("EndLine Top Defective Without Operation"),
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: TypeAheadFormField<RowingQualityTopFaultWithoutOperationListModel>(
                                  ...
                                  suggestionsCallback: (pattern) {
                                    ...
                                    final uniqueMachine = controller.operatorProductionList.where((workOrder) {
                                      String workerID = workOrder.woNumber.toString();
                                      return workerID.toLowerCase().contains(pattern.toLowerCase()) && uniqueWorkerIDs.add(workerID);}).toList();
                                    return uniqueMachine;
                                  },
                                  itemBuilder: (context, RowingQualityTopFaultWithoutOperationListModel suggestion) {
                                    return ListTile(
                                      title: Text(
                                        suggestion.woNumber,
                                      ),
                                  ...
                                  onSuggestionSelected: (RowingQualityTopFaultWithoutOperationListModel suggestion) {
                                    controller.selected = suggestion;
                                    controller.selectedOperation.value = suggestion;
                                    controller.workOrderController.text = suggestion.woNumber;
                                    if (controller.autoFilterEnabled.value) {
                                      controller.autoFilter();
                                    }
                                  },
                                ...
                                child: TypeAheadFormField<RowingQualityTopFaultWithoutOperationListModel>(
                                  ...
                                  suggestionsCallback: (pattern) {
                                    ...
                                    final uniqueOrders = controller.operatorProductionList.where((workOrder) {
                                      int orderId = int.parse(workOrder.woNumber);
                                  ...
                                  itemBuilder: (context, RowingQualityTopFaultWithoutOperationListModel suggestion) {
                                    return ListTile(
                                        title: Text(suggestion.woNumber.toString()));
                                  },
                                  onSuggestionSelected: (RowingQualityTopFaultWithoutOperationListModel suggestion) {
                                    controller.selected = suggestion;
                                    controller.selectedOperation.value = suggestion;
                                    controller.workOrderController.text = suggestion.woNumber.toString();
                                    if (controller.autoFilterEnabled.value) {
                                      controller.autoFilter();
                                    }
                                  },
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        columns: [
                          ...
                          DataColumn(
                            onSort: (_, ascending) {
                              controller.sortData('endLine', ascending);
                            },
                            label: Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  controller.sortData('endLine', true);
                                },
                                child: Row(
                                  children: [
                                    Text(
                          ...
                          DataColumn(
                            onSort: (_, ascending) {
                              controller.sortData('fault', ascending);
                            },
                            label: Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  controller.sortData('fault', true);
                                },
                                child: Row(
                                  children: [
                                    Text(
                          ...
                          DataColumn(
                            onSort: (_, ascending) {
                              controller.sortData('faultsFrequency', ascending);
                            },
                            label: Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  controller.sortData('faultsFrequency', true);
                                },
                                child: Row(
                                  children: [
                                    Text(
                        ...
                        rows: List<DataRow>.generate(
                          controller.operatorProductionList.length,
                              (index) {
                                RowingQualityTopFaultWithoutOperationListModel bundleModel = controller.operatorProductionList[index];
                              ...
                              cells: [
                                ...
                                DataCell(
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(
                                      controller.dateFormat.format(DateTime.parse(bundleModel.transactionDate.toString())),
                                    ),
                                  ),
                                ),
                                DataCell(
                                ...
                                DataCell(
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(bundleModel.woNumber.toString()),
                                  ),
                                ),
                                DataCell(
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child:  Text(bundleModel.endLine)
                                  ),
                                ),
                                ...
                                DataCell(
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child:
                                    Text(bundleModel.fault.toString()),
                                  ),
                                ),
                                DataCell(
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(bundleModel.faultsFrequency.toString()),
                                  ),
                                ),
                              ],
                            );
