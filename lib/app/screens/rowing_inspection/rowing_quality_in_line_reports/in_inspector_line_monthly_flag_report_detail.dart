...
import '../controllers/rowing_quality_in_line_inspector_monthly_flag_detail_report_controller.dart';
...
class InLineOperatorMonthlyFlagDetailReport extends StatelessWidget {
  const InLineOperatorMonthlyFlagDetailReport({super.key});

  @override
  Widget build(BuildContext context) {
    final InLineInspectorMonthlyFlagReportDetailController controller = Get.put(InLineInspectorMonthlyFlagReportDetailController());
    final ScrollController scrollController = ScrollController();
    return Scaffold(
      appBar: AppBar(
        title: const Text("InLine Inspector Flag Detail Report"),
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              controller.getRowingQualityMonthlyFlagDetailReport(
      ...
      body: ListView(
        ...
        children: [
          Align(
            ...
            child: Row(
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: () async {
                    final pdf = await controller.generatePdf(
                        PdfPageFormat.a4, controller.monthlyDetailReportList);
                ...
                // ElevatedButton.icon(
                //   onPressed: () async {
                //     if (controller.monthlyDetailReportList.isNotEmpty) {
                //       final pdfData = await controller.generatePdf(PdfPageFormat.a4, controller.monthlyDetailReportList);
                  ...
                  onPressed: () async {
                    if (controller.monthlyDetailReportList.isNotEmpty) {
                      controller.exportToExcel(
                          controller.monthlyDetailReportList,
          ...
          Obx(() {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        columns: [
                          ...
                          DataColumn(
                            onSort: (_, ascending) {
                              controller.sortData('work-order', ascending);
                            },
                            label: Expanded(
                              child: GestureDetector(
                                onTap: () {
                          ...
                          DataColumn(
                            onSort: (_, ascending) {
                              controller.sortData('round', ascending);
                            },
                            label: Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  controller.sortData('round', true);
                                },
                                child: Row(
                                  children: [
                                    Text(
                        ...
                        rows: List<DataRow>.generate(
                          controller.monthlyDetailReportList.length,
                              (index) {
                            InLineInspectorMonthlyFlagDetailReportListModel
                            bundleModel =
                            controller.monthlyDetailReportList[index];
                            ...
                            return DataRow(
                              ...
                              cells: [
                                ...
                                DataCell(
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(bundleModel.woDetails
                                        .toString()), // Display only one digit after the decimal point
                                  ),
                                ),
                                DataCell(
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child:
                                    Text(bundleModel.roundNo.toString()),
                                  ),
                                ),
                                DataCell(
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(controller.timeFormat.format(DateTime.parse(bundleModel.flagDate.toString())),
                                    ),
                                  ),
                                ),
                                DataCell(
            ...
            } else if (controller.monthlyDetailReportList.isEmpty &&
                controller.isLoading.value) {
