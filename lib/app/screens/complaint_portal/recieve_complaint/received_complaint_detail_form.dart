...
class ReceivedComplaintDetailForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ReceivedComplaintDetailFormController controller = Get.put(ReceivedComplaintDetailFormController());
    return Scaffold(
      appBar: AppBar(
                    ...
                    children: [
                      ...
                      Obx(
                        () => DropdownButtonFormField<ToDepartmentListModel>(
                          ...
                          items:
                              controller.toDepartmentList.map((toDepartment) {
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: DataTable(
                              ...
                              rows: List<DataRow>.generate(
                                ...
                                (index) {
                                  DemandListModel demandModel =
                                      controller.demandList[index];
